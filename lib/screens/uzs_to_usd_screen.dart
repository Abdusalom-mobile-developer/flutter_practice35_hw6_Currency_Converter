...
class UzsToUsdScreen extends StatefulWidget {
  static const String id = "uzs_to_usd_screen";
  const UzsToUsdScreen({
    super.key,
  });

  @override
  State<UzsToUsdScreen> createState() => _UzsToUsdScreenState();
}

class _UzsToUsdScreenState extends State<UzsToUsdScreen> {
